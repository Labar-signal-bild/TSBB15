...
Im1_reg = Im1(interest_point(j,1)-reg_size_x:interest_point(j,1)+reg_size_x-1,...
             interest_point(j,2)-reg_size_y:interest_point(j,2)+reg_size_y-1);


         for i =1:10
             
             Im2_reg = Im2(interest_point(j,1)-reg_size_x:interest_point(j,1)+reg_size_x-1,...
                 interest_point(j,2)-reg_size_y:interest_point(j,2)+reg_size_y-1);
